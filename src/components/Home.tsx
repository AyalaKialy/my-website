...
export default function Home() {
    return (
        <Box id='home' className='box' sx={{ flexGrow: 1 }} >
            <Grid container spacing={1}>
                <Grid xs={11}>
                    <div className='text-box'>
                        <h1>Hi, I'm Ayala Kialy</h1>
                        <h2>A Full Stack developer with passion for learning📖 and codeing👩🏽‍💻.</h2>
                        <a href='CV.pdf' download='CV_Ayala_Kialy.pdf'>
